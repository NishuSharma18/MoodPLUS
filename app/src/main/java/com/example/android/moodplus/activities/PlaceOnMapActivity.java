...
import com.example.android.moodplus.DirectionsJSONParser;
...
public class PlaceOnMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            Toast.makeText(this, "No data please try again.", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        String parameters = str_origin + "&" + str_dest + "&" + sensor + "&key=" + this.getResources().getString(R.string.google_map_key);
