...
public class GlobalMessageAdapter extends
    ...
    @Override
    public GlobalMessageAdapter.GlobalMessageHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(GlobalMessageAdapter.GlobalMessageHolder holder, int position) {
